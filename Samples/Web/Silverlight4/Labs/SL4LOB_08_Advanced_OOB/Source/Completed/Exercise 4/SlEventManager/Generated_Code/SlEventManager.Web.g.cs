...
namespace SlEventManager.Web.Models
{
    ...
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/SlEventManager.Web.Models")]
    public sealed partial class UserDisplayDetails : Entity
    {
...
namespace SlEventManager.Web.Services
{
    ...
    public sealed partial class EventManagerDomainContext : DomainContext
    {
        ...
        public EntitySet<UserDisplayDetails> UserDisplayDetails
        {
            get
            {
                return base.EntityContainer.GetEntitySet<UserDisplayDetails>();
            }
        }
        ...
        /// <summary>
        /// Returns an EntityQuery for query operation 'GetUnacknowledgedAttendeeEventsWithEvents'.
        /// </summary>
        public EntityQuery<AttendeeEvent> GetUnacknowledgedAttendeeEventsWithEventsQuery()
        {
            this.ValidateMethod("GetUnacknowledgedAttendeeEventsWithEventsQuery", null);
            return base.CreateQuery<AttendeeEvent>("GetUnacknowledgedAttendeeEventsWithEvents", null, false, true);
        }
        
        /// <summary>
        /// Returns an EntityQuery for query operation 'GetUserDisplayDetails'.
        /// </summary>
        public EntityQuery<UserDisplayDetails> GetUserDisplayDetailsQuery(int[] attendeeIds)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("attendeeIds", attendeeIds);
            this.ValidateMethod("GetUserDisplayDetailsQuery", parameters);
            return base.CreateQuery<UserDisplayDetails>("GetUserDisplayDetails", parameters, false, true);
        }
        ...
        public InvokeOperation AddTalkToUserSchedule(int talkID, Action<InvokeOperation> callback, object userState)
        {
            ...
            return this.InvokeOperation("AddTalkToUserSchedule", typeof(void), parameters, true, callback, userState);
        }
        ...
        public InvokeOperation AddTalkToUserSchedule(int talkID)
        {
            ...
            parameters.Add("talkID", talkID);
            this.ValidateMethod("AddTalkToUserSchedule", parameters);
            return this.InvokeOperation("AddTalkToUserSchedule", typeof(void), parameters, true, null, null);
        }
        ...
        public InvokeOperation<IEnumerable<int>> FetchEventsForWhichCurrentUserIsRegistered(Action<InvokeOperation<IEnumerable<int>>> callback, object userState)
        {
            ...
            return ((InvokeOperation<IEnumerable<int>>)(this.InvokeOperation("FetchEventsForWhichCurrentUserIsRegistered", typeof(IEnumerable<int>), null, true, callback, userState)));
        }
        
        public InvokeOperation<IEnumerable<int>> FetchEventsForWhichCurrentUserIsRegistered()
        {
            this.ValidateMethod("FetchEventsForWhichCurrentUserIsRegistered", null);
            return ((InvokeOperation<IEnumerable<int>>)(this.InvokeOperation("FetchEventsForWhichCurrentUserIsRegistered", typeof(IEnumerable<int>), null, true, null, null)));
        }
        ...
        public InvokeOperation<IEnumerable<int>> FetchTalksUserHasInScheduleForEvent(int eventID, Action<InvokeOperation<IEnumerable<int>>> callback, object userState)
        {
            ...
            return ((InvokeOperation<IEnumerable<int>>)(this.InvokeOperation("FetchTalksUserHasInScheduleForEvent", typeof(IEnumerable<int>), parameters, true, callback, userState)));
        }
        ...
        public InvokeOperation<IEnumerable<int>> FetchTalksUserHasInScheduleForEvent(int eventID)
        {
            ...
            parameters.Add("eventID", eventID);
            this.ValidateMethod("FetchTalksUserHasInScheduleForEvent", parameters);
            return ((InvokeOperation<IEnumerable<int>>)(this.InvokeOperation("FetchTalksUserHasInScheduleForEvent", typeof(IEnumerable<int>), parameters, true, null, null)));
        }
        ...
        public InvokeOperation<byte[]> GetCurrentUserImage(Action<InvokeOperation<byte[]>> callback, object userState)
        {
            ...
            return ((InvokeOperation<byte[]>)(this.InvokeOperation("GetCurrentUserImage", typeof(byte[]), null, true, callback, userState)));
        }
        
        public InvokeOperation<byte[]> GetCurrentUserImage()
        {
            this.ValidateMethod("GetCurrentUserImage", null);
            return ((InvokeOperation<byte[]>)(this.InvokeOperation("GetCurrentUserImage", typeof(byte[]), null, true, null, null)));
        }
        ...
        public InvokeOperation RegisterCurrentUserForEvent(int eventId, Action<InvokeOperation> callback, object userState)
        {
            ...
            return this.InvokeOperation("RegisterCurrentUserForEvent", typeof(void), parameters, true, callback, userState);
        }
        ...
        public InvokeOperation RegisterCurrentUserForEvent(int eventId)
        {
            ...
            parameters.Add("eventId", eventId);
            this.ValidateMethod("RegisterCurrentUserForEvent", parameters);
            return this.InvokeOperation("RegisterCurrentUserForEvent", typeof(void), parameters, true, null, null);
        }
        ...
        public InvokeOperation RemoveTalkFromUserSchedule(int talkID, Action<InvokeOperation> callback, object userState)
        {
            ...
            return this.InvokeOperation("RemoveTalkFromUserSchedule", typeof(void), parameters, true, callback, userState);
        }
        ...
        public InvokeOperation RemoveTalkFromUserSchedule(int talkID)
        {
            ...
            parameters.Add("talkID", talkID);
            this.ValidateMethod("RemoveTalkFromUserSchedule", parameters);
            return this.InvokeOperation("RemoveTalkFromUserSchedule", typeof(void), parameters, true, null, null);
        }
        ...
        public InvokeOperation SetCurrentUserImage(byte[] imageBytes, Action<InvokeOperation> callback, object userState)
        {
            ...
            return this.InvokeOperation("SetCurrentUserImage", typeof(void), parameters, true, callback, userState);
        }
        ...
        public InvokeOperation SetCurrentUserImage(byte[] imageBytes)
        {
            ...
            parameters.Add("imageBytes", imageBytes);
            this.ValidateMethod("SetCurrentUserImage", parameters);
            return this.InvokeOperation("SetCurrentUserImage", typeof(void), parameters, true, null, null);
        }
        ...
        public InvokeOperation UnregisterCurrentUserForEvent(int eventId, Action<InvokeOperation> callback, object userState)
        {
            ...
            return this.InvokeOperation("UnregisterCurrentUserForEvent", typeof(void), parameters, true, callback, userState);
        }
        ...
        public InvokeOperation UnregisterCurrentUserForEvent(int eventId)
        {
            ...
            parameters.Add("eventId", eventId);
            this.ValidateMethod("UnregisterCurrentUserForEvent", parameters);
            return this.InvokeOperation("UnregisterCurrentUserForEvent", typeof(void), parameters, true, null, null);
        }
        ...
        public interface IEventManagerDomainServiceContract
        {
            ...
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/EventManagerDomainService/GetUnacknowledgedAttendeeEventsWithE" +
                "ventsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/EventManagerDomainService/GetUnacknowledgedAttendeeEventsWithE" +
                "vents", ReplyAction="http://tempuri.org/EventManagerDomainService/GetUnacknowledgedAttendeeEventsWithE" +
                "ventsResponse")]
            [WebGet()]
            IAsyncResult BeginGetUnacknowledgedAttendeeEventsWithEvents(AsyncCallback callback, object asyncState);
            
            QueryResult<AttendeeEvent> EndGetUnacknowledgedAttendeeEventsWithEvents(IAsyncResult result);
            
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/EventManagerDomainService/GetUserDisplayDetailsDomainServiceFa" +
                "ult", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/EventManagerDomainService/GetUserDisplayDetails", ReplyAction="http://tempuri.org/EventManagerDomainService/GetUserDisplayDetailsResponse")]
            [WebGet()]
            IAsyncResult BeginGetUserDisplayDetails(int[] attendeeIds, AsyncCallback callback, object asyncState);
            
            QueryResult<UserDisplayDetails> EndGetUserDisplayDetails(IAsyncResult result);
        ...
        internal sealed class EventManagerDomainContextEntityContainer : EntityContainer
        {
            ...
            public EventManagerDomainContextEntityContainer()
            {
                ...
                this.CreateEntitySet<UserDisplayDetails>(EntitySetOperations.None);
