<%@ Page Language="C#" MasterPageFile="~/Management/Site.master" CodeBehind="Details.aspx.cs" Inherits="Silverlight.Weblog.UI.Web.Management.DynamicData.PageTemplates.Details" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HyperLink ID="EditHyperLink" runat="server"
                                NavigateUrl='<%# table.GetActionPath(System.Web.DynamicData.PageAction.Edit, GetDataItem()) %>'
                                Text="Edit" />
